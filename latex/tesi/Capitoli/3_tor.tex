...
\begin{itemize}
    ...
    \item \textbf{Directory Server}, nodi più fidati di altri che descrivono le informazioni di rete in maniera sicura e affidabile.
