...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
	\begin{frame}{Computer Science @ Unicam}
		...
		\begin{itemize}
			\item Professore e relatore: Marcantoni Fausto https://computerscience.unicam.it/marcantoni/
			\item Studente: Leonardo Migliorelli leonardo.migliorelli@studenti.unicam.it MAT. 113920
		\end{itemize}
	\end{frame}
}
